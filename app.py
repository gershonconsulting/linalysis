            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="menu-item-with-nested">
                        ...
                        <div class="nested-menu">
                            <a href="#" onclick="handleSubMenuClick('My Campaigns', 'Summary')">Summary</a>
                            <a href="#" onclick="handleSubMenuClick('My Campaigns', 'Graphs')">Graphs</a>
                            <a href="#" onclick="handleSubMenuClick('My Campaigns', 'Data')">Data</a>
                            <a href="#" onclick="handleSubMenuClick('My Campaigns', 'Settings')">Settings</a>
                        </div>
                    </div>
        ...
        if df is None or df.empty:
            ...
            if start_date > end_date:
                ...
                if category == "Dashboard":
                    ...
                    st.markdown('<div class="highlight-box">Analyze your LinkedIn messaging campaigns to improve your outreach strategy. Track performance metrics, identify trends, and optimize your campaigns for better results.</div>', unsafe_allow_html=True)
